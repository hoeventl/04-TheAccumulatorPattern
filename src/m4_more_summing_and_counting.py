...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 3
    answer = count_cosines_from(-2, 3, -0.3)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(10, 17, -0.25)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 5.082571  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 90)
